        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto w-100 justify-content-center">
            ...
            <Nav.Link
              ...
              to="/places"
              className={`text-light ${
                activeLink === "/placespage" ? "active-link" : ""
              }`}
            >
              Popular Places
            </Nav.Link>
            <Nav.Link
              ...
              to="/restaurants"
              className={`text-light ${
                activeLink === "/restaurant" ? "active-link" : ""
              }`}
            >
              Restaurants
            </Nav.Link>
            <Nav.Link
              ...
              to="/hospital"
              className={`text-light ${
                activeLink === "/hospital" ? "active-link" : ""
              }`}
            >
              Hospital
            </Nav.Link>
            ...
            <Nav.Link
              ...
              to="/plan-your-trip"
              className={`text-light ${
                activeLink === "/plan-your-trip" ? "active-link" : ""
              }`}
            >
              Plan Your Trip
            </Nav.Link>
            <Nav.Link
              ...
              to={"/explore-cities"}
              className={`text-light ${
                activeLink === "/explore-cities" ? "active-link" : ""
              }`}
            >
              Cities
            </Nav.Link>
